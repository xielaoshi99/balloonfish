...
export async function sendRequest(sqlStr, payload) {
  // console.log(sqlStr)
  try {
    let res = await post(`http://${payload.ip}:${payload.port}/rest/sql`, sqlStr, {
      auth: {
...
export function selectData(tableName, dbName, payload, fields = null, where = null, limit = null, offset = null, desc = null, startTime = null, endTime = null) {
  //首先查询一次，获取表的整体情况
