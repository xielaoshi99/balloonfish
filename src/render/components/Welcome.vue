      ...
      <el-col :span="24">
        <el-card shadow="hover">
          ...
          <div class="softInfo">
            ...
            <el-button size="medium">查看组件版本</el-button>
            <!-- <div>
              <p>electron：13.1.4</p>
              <p>vue：3.1.2</p>
              <p>element-plus：1.0.2</p>
              <p>chrome：1.0.2</p>
              <p>Node：14.12.0</p>
            </div> -->
...
export default {
  ...
  methods: {
    async getYiYan() {
      ...
      this.yiYanAuthor =
        "——" + (res.data.from_who || "") + "《" + res.data.from + "》";
    },
    getTime() {
      ...
      setInterval(() => {
        ...
        this.date =
          nowDate.getFullYear() +
          "年" +
          this.shorter(monthStr) +
          "月" +
          this.shorter(dayStr) +
          "日 " +
          wd;
        this.time =
          this.shorter(hh) + ":" + this.shorter(mm) + ":" + this.shorter(ss);
      }, 1000);
    },
    shorter(inStr) {
